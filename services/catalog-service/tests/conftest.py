...
TEST_DSN = os.getenv(
    "CATALOG_TEST_POSTGRES_DSN",
    "postgresql+asyncpg://catalog_user:catalog_pass@localhost:5432/catalog_db_test",
)

_TABLES = ("consumption_norms", "services", "consumables")
...
class RecordingPublisher(EventPublisher):
    ...
    def __init__(self) -> None:
        super().__init__("", "catalog-service")
