...
| Документ | О чём |
|---|---|
| [`docs/architecture.pdf`](docs/architecture.pdf) | Описание системы на 22 страницы: декомпозиция, транспорт, события, данные, сквозные решения и разбор каждого сервиса. Шесть векторных схем |
