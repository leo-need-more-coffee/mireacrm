...
Тесты — 287, два вида: unit без ввода-вывода и интеграционные против настоящего
...
| Работа | Что делает |
|---|---|
| Контракты | линтер `.proto` и проверка, что `gen/` не разошёлся с `proto/` |
...
| `booking-service` | REST, gRPC, RabbitMQ, NATS, Docker, 48 тестов |
...
| `billing-service` | REST, потребитель событий, gRPC-клиент, Docker, 29 тестов |
...
| `gateway` | OIDC, роли, проброс личности, Docker, 62 тестов |
